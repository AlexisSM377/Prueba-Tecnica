...
export default function Create({ alumno, materias }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/alumnos/${alumno.id}/materias`);
    }

    return (
        <AppLayout>
            <Head title={`Asignar materias a ${alumno.name}`} />
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="flex items-center gap-4">
                    <Link href={`/alumnos/${alumno.id}/materias`}>
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Seleccionar las materias para el alumno {alumno.name}
                        </p>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Selecciona una o más materias para asignar al alumno
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {materias.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center py-12">
                                        ...
                                        <p className="mb-4 text-center text-sm text-muted-foreground">
                                            Todas las materias ya están asignadas a este alumno o no existen materias en el sistema.
                                        </p>
